...
class Geometry(object):
    ...
    def __repr__(self):
        ...
        for element in self.geometry:
            line = element[1].center(11) + ' ' + str(element[2]).rjust(19) + ' ' + str(element[3]).rjust(19) + ' ' + str(element[4]).rjust(19)
            string = string + line + '\n'
        return string
    ...
    def write_geometry(self, path):
        with open(path, 'a') as f:
            for element in self.geometry:
                ...
                f.write(str(element[2]).rjust(19) + ' ')
                f.write(str(element[3]).rjust(19) + ' ')
                f.write(str(element[4]).rjust(19))
                f.write('\n')
